  ...
  return (
    <div className="flex-1 flex flex-col justify-center space-y-16 py-12 animate-in fade-in duration-1000">
      <header className="text-center space-y-4">
        ...
        <h2 className="text-4xl font-serif italic text-primary leading-tight">A choice of perspective.</h2>
      </header>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <p className="text-xl text-center text-muted-foreground px-8">
          ...
          <div className="grid grid-cols-1 gap-6 max-w-sm mx-auto">
            <button
              ...
              className="group p-8 bg-card border border-border shadow-[0_4px_24px_rgba(0,0,0,0.02)] rounded-[2.5rem] hover:bg-primary transition-all duration-500 text-left"
            >
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center group-hover:bg-primary-foreground group-hover:text-primary transition-colors">
